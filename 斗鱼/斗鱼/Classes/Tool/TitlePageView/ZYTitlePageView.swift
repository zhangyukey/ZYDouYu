...
protocol PageTitleViewDelegate : class  {
    ...
    func pageTitleView(titleView:ZYTitlePageView,selectedIndex index: Int)
}



class ZYTitlePageView: UIView {
    ...
    private lazy var option : ZYPageOptions = {
    ...
    init(frame : CGRect , titles : [String] , options: ZYPageOptions? = nil) {
